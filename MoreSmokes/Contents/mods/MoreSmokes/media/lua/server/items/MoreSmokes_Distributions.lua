...
local magazinesHighRarity = sBvars.Magazines * sBvars.Loot * 0.1;
...
if sBvars.YesCannabis and sBvars.RareMagazines then
    MoreSmokes:addDistributions({
        -- Recipe Magazines

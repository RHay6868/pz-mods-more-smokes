...
BTSE.Farming:addNewCrop({
    ...
    normalHarvestMin = MoreSmokes:getHarvestCount(3),
    normalHarvestMax = MoreSmokes:getHarvestCount(4, true),
    abundantHarvestMin = MoreSmokes:getHarvestCount(4),
    abundantHarvestMax = MoreSmokes:getHarvestCount(5, true),
